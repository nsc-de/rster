...
<div align="center">
  ...
  <a href="https://github.com/nsc-de/rster">
    ...
    <a href="https://github.com/nsc-de/rster/tree/master/packages/types">
    <img src="https://raw.githubusercontent.com/nsc-de/rster/master/images/%40rster/package-types.png" alt="Logo" height="80" className="height-80px" />
  </a>

<h3 align="center">@rster/types</h3>
...
`@rster/types` is a package of the `rster` project. It provides the type system rster uses to type-check data sent to the server and from the server. If you use the default `rster` package, `@rster/types` will be bundled. Find tutorials and documentation on the [rster website](https://nsc-de.github.io/rster/). The package is available on [npm](https://www.npmjs.com/package/@rster/types).

[rster repository](https://github.com/nsc-de/rster)
·
[rster package on npm](https://www.npmjs.com/package/@rster/types)
·
...
[github-url]: https://github.com/nsc-de/rster/tree/master/packages/types
[npm-shield]: https://img.shields.io/badge/npm-red?style=for-the-badge&logo=npm
[npm-url]: https://www.npmjs.com/package/%40rster/types
[typedoc-shield]: https://img.shields.io/badge/typedoc-darkblue?style=for-the-badge&logo=typescript
[typedoc-url]: https://nsc-de.github.io/rster/docs/api-reference/types/
...
[version-shield]: https://img.shields.io/npm/v/@rster/types?style=for-the-badge
[downloads-shield]: https://img.shields.io/npm/dt/@rster/types?style=for-the-badge
