...
<div align="center">
  ...
  <a href="https://github.com/nsc-de/rster">
    ...
    <a href="https://github.com/nsc-de/rster/tree/master/packages/worker-express">
    <img src="https://raw.githubusercontent.com/nsc-de/rster/master/images/%40rster/package-worker-express.png" alt="Logo" height="80" className="height-80px" />
  </a>

<h3 align="center">@rster/worker-express</h3>
...
`@rster/worker-express` is a package of the `rster` project. It provides a rster-worker for express.js, so you can use your rster app as a express middleware.
Find tutorials and documentation on the [rster website](https://nsc-de.github.io/rster/). The package is available on [npm](https://www.npmjs.com/package/@rster/worker-express).

[rster repository](https://github.com/nsc-de/rster)
·
[rster package on npm](https://www.npmjs.com/package/@rster/worker-express)
·
...
[github-url]: https://github.com/nsc-de/rster/tree/master/packages/worker-express
[npm-shield]: https://img.shields.io/badge/npm-red?style=for-the-badge&logo=npm
[npm-url]: https://www.npmjs.com/package/%40rster/worker-express
[typedoc-shield]: https://img.shields.io/badge/typedoc-darkblue?style=for-the-badge&logo=typescript
[typedoc-url]: https://nsc-de.github.io/rster/docs/api-reference/worker-express/
...
[version-shield]: https://img.shields.io/npm/v/@rster/worker-express?style=for-the-badge
[downloads-shield]: https://img.shields.io/npm/dt/@rster/worker-express?style=for-the-badge
